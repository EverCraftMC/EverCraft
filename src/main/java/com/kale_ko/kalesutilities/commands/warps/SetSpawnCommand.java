        ...
        if (Util.hasPermission(sender, "kalesutilities.setspawn")) {
            ...
            if (sender instanceof Player player) {
                ...
                try {
                    ...
                    Util.sendMessage(sender, KalesUtilities.Instance.config.getString("messages.setspawn"));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            } else {
            ...
            Util.sendMessage(sender, KalesUtilities.Instance.config.getString("messages.usage").replace("{usage}", KalesUtilities.Instance.getCommand("setspawn").getUsage()));
        }
