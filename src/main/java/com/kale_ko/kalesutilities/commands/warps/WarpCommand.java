    ...
    public boolean onCommand(CommandSender sender, org.bukkit.command.Command command, String label, String[] args) {
        if (Util.hasPermission(sender, "kalesutilities.warp")) {
            if (sender instanceof Player player) {
                player.teleport(new Location(Main.Instance.getServer().getWorld(Main.Instance.warps.getConfig().getString(args[0] + ".world")), Main.Instance.warps.getConfig().getDouble(args[0] + ".x"), Main.Instance.warps.getConfig().getDouble(args[0] + ".y"), Main.Instance.warps.getConfig().getDouble(args[0] + ".z"), Float.parseFloat(Main.Instance.warps.getConfig().getString(args[0] + ".yaw")), Float.parseFloat(Main.Instance.warps.getConfig().getString(args[0] + ".pitch"))));
