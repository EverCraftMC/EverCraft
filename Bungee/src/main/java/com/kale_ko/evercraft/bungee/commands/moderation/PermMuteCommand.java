    ...
    public void run(CommandSender sender, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (player != null) {
                ...
                BungeeMain.getInstance().getPlayerData().set("players." + player.getUniqueId() + ".mute.muted", true);
                BungeeMain.getInstance().getPlayerData().set("players." + player.getUniqueId() + ".mute.reason", null);
                BungeeMain.getInstance().getPlayerData().set("players." + player.getUniqueId() + ".ban.by", senderName);
                BungeeMain.getInstance().getPlayerData().set("players." + player.getUniqueId() + ".mute.until", "forever");
            }
            ...
            if (player != null) {
                ...
                BungeeMain.getInstance().getPlayerData().set("players." + player.getUniqueId() + ".mute.muted", true);
                BungeeMain.getInstance().getPlayerData().set("players." + player.getUniqueId() + ".mute.reason", reason.substring(0, reason.length() - 1));
                BungeeMain.getInstance().getPlayerData().set("players." + player.getUniqueId() + ".ban.by", senderName);
                BungeeMain.getInstance().getPlayerData().set("players." + player.getUniqueId() + ".mute.until", "forever");
            }
        } else {
