...
import io.github.evercraftmc.evercraft.bungee.commands.link.UnLinkCommand;
...
public class BungeeMain extends Plugin implements io.github.evercraftmc.evercraft.shared.Plugin {
    ...
    public void onEnable() {
        ...
        this.commands.add(new UnLinkCommand("unlink", "Unlink your Minecraft account from Discord", Arrays.asList("unlinkdiscord"), null).register());
