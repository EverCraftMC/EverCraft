                    ...
                    if (ModerationUtil.isSuperInappropriateString(message.trim())) {
                        ...
                        if (warnings.get(player.getUniqueId()) >= 1 && warnings.get(player.getUniqueId()) <= 5) {
                            for (ProxiedPlayer player2 : BungeeMain.getInstance().getProxy().getPlayers()) {
                                player2.sendMessage(ComponentFormatter.stringToComponent(TextFormatter.translateColors(BungeeMain.getInstance().getPluginMessages().getParsed().moderation.chat.warning.replace("{player}", player.getDisplayName()))));
                            }
                        ...
                        for (ProxiedPlayer player2 : BungeeMain.getInstance().getProxy().getPlayers()) {
                            if (player2.getServer().getInfo().getName().equalsIgnoreCase(sender)) {
                                ...
                                player2.sendMessage(ComponentFormatter.stringToComponent(TextFormatter.translateColors(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", BungeeMain.getInstance().getPluginMessages().getParsed().chat.main.replace("{player}", player.getDisplayName()).replace("{message}", message)))));
                            }
                        }

                        BungeeMain.getInstance().getDiscordBot().getGuild().getTextChannelById(BungeeMain.getInstance().getPluginConfig().getParsed().discord.channelId).sendMessage(TextFormatter.discordFormat(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", BungeeMain.getInstance().getPluginMessages().getParsed().chat.main.replace("{player}", player.getDisplayName()).replace("{message}", message)))).queue();
                    }
                } else if (BungeeMain.getInstance().getPluginData().getParsed().chatLock) {
                    player.sendMessage(ComponentFormatter.stringToComponent(TextFormatter.translateColors(BungeeMain.getInstance().getPluginMessages().getParsed().moderation.chatLock.chat)));
                } else {
                    String time = BungeeMain.getInstance().getPluginData().getParsed().players.get(player.getUniqueId().toString()).mute.until;

                    if (time.equalsIgnoreCase("forever") || Instant.parse(time).isAfter(Instant.now())) {
                        if (BungeeMain.getInstance().getPluginData().getParsed().players.get(player.getUniqueId().toString()).mute.reason != null) {
                            player.sendMessage(ComponentFormatter.stringToComponent(TextFormatter.translateColors(BungeeMain.getInstance().getPluginMessages().getParsed().moderation.mute.reason.replace("{reason}", BungeeMain.getInstance().getPluginData().getParsed().players.get(player.getUniqueId().toString()).mute.reason).replace("{moderator}", BungeeMain.getInstance().getPluginData().getParsed().players.get(player.getUniqueId().toString()).mute.by).replace("{time}", time))));
                        } else {
                            player.sendMessage(ComponentFormatter.stringToComponent(TextFormatter.translateColors(BungeeMain.getInstance().getPluginMessages().getParsed().moderation.mute.noReason.replace("{moderator}", BungeeMain.getInstance().getPluginData().getParsed().players.get(player.getUniqueId().toString()).mute.by).replace("{time}", time))));
                        }
                    } else {
                        BungeeMain.getInstance().getPluginData().getParsed().players.get(player.getUniqueId().toString()).mute.muted = false;
                ...
                for (ProxiedPlayer player2 : BungeeMain.getInstance().getProxy().getPlayers()) {
                    if (!isJson) {
                        if (player2.getServer().getInfo().getName().equalsIgnoreCase(sender)) {
                            ...
                            player2.sendMessage(ComponentFormatter.stringToComponent(TextFormatter.translateColors(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", message.replace("{player}", player.getDisplayName() + "&r")))));
                        }
                    } else {
                        if (player2.getServer().getInfo().getName().equalsIgnoreCase(sender)) {
                            ...
                            player2.sendMessage(ComponentFormatter.stringToComponent(TextFormatter.translateColors(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", ComponentFormatter.componentToString(ComponentFormatter.jsonToComponent(message)).replace("{player}", player.getDisplayName() + "&r")))));
                        }
                    }
                }

                if (!isJson) {
                    BungeeMain.getInstance().getDiscordBot().getGuild().getTextChannelById(BungeeMain.getInstance().getPluginConfig().getParsed().discord.channelId).sendMessage(TextFormatter.discordFormat(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", message.replace("{player}", player.getDisplayName())))).queue();
                } else {
                    BungeeMain.getInstance().getDiscordBot().getGuild().getTextChannelById(BungeeMain.getInstance().getPluginConfig().getParsed().discord.channelId).sendMessage(TextFormatter.discordFormat(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", ComponentFormatter.componentToString(ComponentFormatter.jsonToComponent(message)).replace("{player}", player.getDisplayName() + "&r")))).queue();
                }
                ...
                for (ProxiedPlayer player : BungeeMain.getInstance().getProxy().getPlayers()) {
                    if (!isJson) {
                        if (player.getServer().getInfo().getName().equalsIgnoreCase(sender)) {
                            ...
                            player.sendMessage(ComponentFormatter.stringToComponent(TextFormatter.translateColors(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", message))));
                        }
                    } else {
                        if (player.getServer().getInfo().getName().equalsIgnoreCase(sender)) {
                            player.sendMessage(ComponentFormatter.jsonToComponent(message));
                        } else {
                            player.sendMessage(ComponentFormatter.stringToComponent(TextFormatter.translateColors(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", ComponentFormatter.componentToString(ComponentFormatter.jsonToComponent(message))))));
                        }
                    }
                }

                if (!isJson) {
                    BungeeMain.getInstance().getDiscordBot().getGuild().getTextChannelById(BungeeMain.getInstance().getPluginConfig().getParsed().discord.channelId).sendMessage(TextFormatter.discordFormat(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", in.readUTF()))).queue();
                } else {
                    BungeeMain.getInstance().getDiscordBot().getGuild().getTextChannelById(BungeeMain.getInstance().getPluginConfig().getParsed().discord.channelId).sendMessage(TextFormatter.discordFormat(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", ComponentFormatter.componentToString(ComponentFormatter.jsonToComponent(message))))).queue();
                }
                        ...
                        if (player2 != player && player2.hasPermission("evercraft.commands.staff.commandspy") && BungeeMain.getInstance().getPluginData().getParsed().players.get(player.getUniqueId().toString()).settings.commandspy) {
                            if (!(!player2.hasPermission("evercraft.commands.staff.commandspy.extra") && (message.startsWith("/message") || message.startsWith("/msg") || message.startsWith("/reply") || message.startsWith("/r") || message.startsWith("/staffchat") || message.startsWith("/sc")))) {
                                if (player2.getServer().getInfo().getName().equalsIgnoreCase(sender)) {
                                    ...
                                    player2.sendMessage(ComponentFormatter.stringToComponent(TextFormatter.translateColors(BungeeMain.getInstance().getPluginMessages().getParsed().globalMessage.replace("{server}", sender).replace("{message}", BungeeMain.getInstance().getPluginMessages().getParsed().chat.commandSpy.replace("{player}", player.getDisplayName()).replace("{message}", message)))));
                                }
                            }
                        }
                    }
