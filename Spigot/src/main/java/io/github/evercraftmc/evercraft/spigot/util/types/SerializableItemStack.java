...
public class SerializableItemStack {
    ...
    private SerializableItemStack(Material type, String name, Integer amount, Integer damage, List<String> lore, List<SerializableEnchantment> enchantments) {
        this.type = type;
        this.name = name;
        this.amount = amount;
        this.damage = damage;
    ...
    public ItemStack toBukkitItemStack() {
        ...
        for (SerializableEnchantment enchantment : this.getEnchantments()) {
            stack.getEnchants().put(enchantment.getEnchantment(), enchantment.getLevel());
        }
